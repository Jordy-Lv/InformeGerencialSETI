...
- [x] Comprobar visualmente el PDF con preset mínimo y máximo.
...
entregable. El usuario comprobó visualmente el 5 de agosto de 2026 el PDF
con una selección reducida y con el preset restaurado: las tarjetas
deseleccionadas ya no se exportan y el informe completo vuelve a generarse.
