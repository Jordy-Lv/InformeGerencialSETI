...
Cada caso SHALL incluir identidad, fecha, cliente, origen, tipo, categoría,
jerarquía, SLA, motor, ambiente y atribuibilidad; los valores desconocidos
SHALL conservarse como `null`.
