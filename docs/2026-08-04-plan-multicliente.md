...
| F5 | **En validación A/B.** GLPI y AlertsList ya se adaptan a `CasoCanonico`; las cabeceras ambiguas se rechazan con sus candidatos y la autoprueba cubre SLA desconocido. Falta cotejar un export real con el preset predeterminado. |
| F6–F11 | Pendientes |
