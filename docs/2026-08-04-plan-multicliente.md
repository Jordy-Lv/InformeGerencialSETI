...
| F4 | **Implementada técnicamente; pendiente de validación visual y A/B.** El panel ya se genera desde la presentación declarativa del inventario, el selector persiste por perfil y el PDF/exportado usan la selección efectiva. Aún debe comprobarse en un navegador el preset mínimo y máximo, y producir el A/B real con el preset predeterminado. |
| F5–F11 | Pendientes |
