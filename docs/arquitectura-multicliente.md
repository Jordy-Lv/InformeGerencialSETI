# Arquitectura objetivo — plataforma multicliente

**Qué es esto:** la parte **estable** del plan maestro de la migración
multicliente (F0–F11): contexto, decisiones ya tomadas, arquitectura
objetivo, estructura de OpenSpec, criterio de aceptación por fase, archivos
críticos, verificación y riesgos. No cambia salvo que cambie el diseño
mismo.

**Lo que NO está aquí:** el estado de ejecución de cada fase (qué está
mergeado, qué falta). Eso vive en [`TASKS.md`](../TASKS.md) — cambia cada
sesión y por eso se separó de este documento. El razonamiento completo,
sesión por sesión, sigue en
[`archivo/2026-08-04-plan-multicliente.md`](archivo/2026-08-04-plan-multicliente.md),
la versión original de la que se extrajo este archivo.

Los siete patrones de diseño (Registry, Strategy, Adapter+Canónico…) y la
regla **dato o código** que decide todo lo demás viven en
[`PATRONES.md`](PATRONES.md) — no se repiten aquí.
...
compartida JS↔Python) y lo descartado con nombre están en
